...
latex_documents = [(master_doc, "SweetRPG-Library Model.tex", u"SweetRPG Library Model Documentation", u"Paul Schifferer", "manual")]
...
texinfo_documents = [
    (
        ...
        u"SweetRPG Library Model Documentation",
        author,
        "SweetRPG Library Model",
